...
import com.java.common.ProcessCommand;
import com.java.common.StreamHandlerCommon;
...
public class VideoOperation {
    private static String ffmpegEXE = "C:/Users/Filipp/Documents/ffmpeg/bin/ffmpeg.exe";
    ...
    public Result videoConvert(String inputVideo, String outputVideo)  {
        ...
        try {
            ...
            return StreamHandlerCommon.closeStreamQuietly(proc);
        } catch (IOException e) {
...
//     ffmpeg -i bgm.mp3 -i input.mp4 -t 6 -filter_complex amix=inputs=2 output.mp4
        try {
            if(StrUtils.checkBlank(bgm) || StrUtils.checkBlank(inputVideo) || StrUtils.checkBlank(outputVideo) || seconds <= 0) {
                throw new FFMpegExceptionn("Please enter the correct parameters, the parameters cannot be empty");
            }
...
//        ffmpeg -ss 00:00:01 -y -i input.mp4 -vframes 1 out.jpg
        try {
            if(StrUtils.checkBlank(inputVideo) || StrUtils.checkBlank(coverOut)) {
                throw new FFMpegExceptionn("Please enter the video path or cover image input parameters");
            }
...
//       ffmpeg -y -i source.mp4 -an -vcodec copy output.mp4
    ...
    public void videoScale(Long inputVideo, Long outWidth, Long outHeight) {
//       ffmpeg -y -i in.mp4 -vf scale=360:640 -acodec aac -vcodec h264 out.mp4
        String inputPath = "/Users/Filipp/Documents/VideoTest/" + inputVideo.toString() + ".mp4";
        String outputVideo = "/Users/Filipp/Documents/VideoTest/1/out.mp4";

        if(StrUtils.checkBlank(inputPath) || StrUtils.checkBlank(outputVideo)) {
            throw new FFMpegExceptionn("Please enter the correct parameters, the parameters cannot be empty!");
        }
        BaseFileUtil.checkAndMkdir(outputVideo);
        ...
        try {
            ...
            commands.add("-vf");
            commands.add("scale="+ outWidth.toString() + ":" + outHeight.toString());
            ...
            StreamHandlerCommon.closeStreamQuietly(process);
        } catch (IOException e) {
            throw new FFMpegExceptionn(e.getMessage());
        }
    }
...
//        ffmpeg -i nosound.mp4 -i songs.mp3 -t 7.1 -c copy output.mp4
    ...
    private Result convertNoSoundVideoToBgmVideo(String videoOutPath, String noSoundVideoPath,String bgmInputPath, double seconds) throws IOException {
        ...
        return StreamHandlerCommon.closeStreamQuietly(process2);
    }
